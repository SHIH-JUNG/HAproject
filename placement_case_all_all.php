                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <!--                                                        <div>填表日期：2021/04/01</div>-->
                                                                <table id="placement_case_all" style="width:auto;" class="table table-bordered">
                                                                    <th>姓名</th>
                                                                    <th>開案日期</th>
                                                                    <th>個案紀錄</th>
                                                                    <tbody id="placement_case_add"></tbody>
                                                                </table>
                                                                <button style="font-size:20px" onclick="window.location.href = 'placement_case.php';" class="btn btn-default">返回</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<!--
                                                        <div class="text-right">       
                                                            ...
                                                            <button id="end" style="font-size:15px" type="button" class="btn btn-default">結案</button>
                                                        </div>
-->
                                            </div>
                                        </div>
