            ...
            <div class="container-fluid ">
                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="training_list.php">員工管理</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span>員工在職訓練紀錄</span></li>
                    </ol>
                    <!--/麵包屑-->
                </div>
                <!-- /Title -->
                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="tra_list_all" style="width:auto;" class="table table-bordered">
                                                                    <th>姓名</th>
                                                                    <th>在職訓練紀錄</th>
                                                                    <tbody id="tra_list_all"></tbody>
                                                                </table> -->
                                                                <br>
                                                                <button style="font-size:20px" onclick="location.href='training_on.php';" class="btn btn-default">在職員工訓練資料</button>
                                                                <br>
                                                                <br>
                                                                <button style="font-size:20px" onclick="location.href='training_off.php';" class="btn btn-default">離職員工訓練資料</button>
