                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="profile-tab1">
                                    ...
                                    <div class="text-right">
                                        <button style="font-size:20px" class="btn btn-default" onclick="generatePDF2()">匯出菸癮狀況為PDF</button>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="three" role="tabpanel" aria-labelledby="profile-tab2">
                                    ...
                                    <div class="text-right">
                                        <button style="font-size:20px" class="btn btn-default" onclick="generatePDF3()">匯出就診紀錄表為PDF</button>
                                    </div>
                                </div>
