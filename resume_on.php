                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="res_on_all" style="width:auto;" class="table table-bordered">
                                                                    <th>姓名</th>
                                                                    <th>履歷表檔案</th>
                                                                    <tbody id="res_on_add"></tbody>
                                                                </table>
                                                                <br>
                                                                <button style="font-size:20px" onclick="location.href='add_resume.php';" class="btn btn-default">新增履歷表資料</button>
...
-->
    ...
    <script src='js/resume_on.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
