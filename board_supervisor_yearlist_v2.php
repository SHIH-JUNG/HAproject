                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <button style="font-size:20px" onclick="location.href='add_board_supervisor_v2.php';" class="btn btn-default">
...
-->
    ...
    <!-- ================== board_supervisor_yearlist_v2.js ================== -->
    <script src='js/board_supervisor_yearlist_v2.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
