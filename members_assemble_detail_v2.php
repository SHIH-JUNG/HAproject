...
<body>
            ...
            <div class="container-fluid ">
                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="members_assemble_yearlist_v2.php">行政管理</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><a href="members_assemble_yearlist_v2.php">會議管理</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><a href="members_assemble_yearlist_v2.php">會員大會記錄</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <?php echo "<li><span><a href='members_assemble_v2.php?year=".trim($rec_year)."'>".trim($rec_year)."年度會員大會記錄</a></span></li>"; ?>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                                                                        ...
                                                                        <form id="form_a" class="form">
                                                                            <table style="width:75%;margin-bottom: 0px;" class="table table-bordered">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="ma_question" id="upload_agenda_date" name="upload_agenda_date" datepicker="ch_datepicker" type="text"></div></td>
                                                                                </tr>
                                                                                <tr style="text-align:left">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="col-sm-10"><textarea class="ma_question" style="height:10em;width:100%;resize: none;font-size: 20px;" id="upload_agenda_remark" name="upload_agenda_remark" placeholder="請輸入備註"></textarea></div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </from>
                                                                ...
                                                                <div class="panel-heading" id="headingTwo">
                                                                    <h2 class="mb-0">
                                                                        <button class="btn btn-link btn-block collapsed" type="button" data-toggle="collapse" data-parent="#myTabContent" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                            <span style="color:black;font-size:17px">會員大會記錄</span>
                                                                        </button>
                                                                    </h2>
                                                                </div>
                                                                <div id="collapseTwo" class="collapse in" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                                    <div class="panel-body scr_container">
                                                                        <form id="form_b" class="form" action="">
                                                                            <table style="width:75%;margin-bottom: 0px;" class="table table-bordered">
                                                                                <tr style="text-align:left">
                                                                                    <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;width:12em;">會員大會記錄標題</td>
                                                                                    <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="ma_question" id="upload_title_name" name="upload_title_name" type="text" style="width:100%;"></div></td>
                                                                                </tr>
                                                                                <tr style="text-align:left">
                                                                                    <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">上傳日期</td>
                                                                                    <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="ma_question" id="upload_rec_date" name="upload_rec_date" datepicker="ch_datepicker" type="text"></div></td>
                                                                                </tr>
                                                                                <tr style="text-align:left">
                                                                                    <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">檔案上傳</td>
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    <td style="text-align:right;background-color:rgb(255 201 54);border-right-color: white">備註</td>
                                                                                    <td>
                                                                                        <div class="col-sm-10"><textarea class="ma_question" style="height:10em;width:100%;resize: none;font-size: 20px;" id="upload_rec_remark" name="upload_rec_remark" placeholder="請輸入備註"></textarea></div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        <div class="col-sm-3" style="margin-top: 0.6em;">
                                                                                            <select class="ma_question" name="director" id="director" style="width:100%;">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        <div class="col-sm-3" style="margin-top: 0.6em;">
                                                                                            <select class="ma_question" name="supervise" id="supervise" style="width:100%;">
                                                                                                <option value="">請選擇</option>
                                                                                            </select>
                                                                                        </div>
                                                                                        <div class="col-sm-9">
    ...
    <!-- ================== detail ================== -->
    <script type="text/javascript" src="js/members_assemble_detail_v2.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
