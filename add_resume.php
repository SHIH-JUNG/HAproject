                                                            ...
                                                            <form id="form_a" class="form">
                                                                <table style="width:55%;" class="table table-bordered">
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;"><input id="upload_date" name="ch_datepicker" type="text"></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;">
                                                                            ...
                                                                            <select id="file1_check" style="width:200px;">
                                                                                <option value="是">是</option>
                                                                                <option value="否">否</option>
                                                                            </select>
                                                                        </td>
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;">
                                                                            <div class="container">
                                                                                <form method="post" action="" enctype="multipart/form-data" id="myform">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="file" id="customFile2" name="customFile2" />
                                                                                        <!-- <input type="button" class="button" value="Upload" id="but_upload"> -->
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                            <select id="file2_check" style="width:200px;">
                                                                                <option value="是">是</option>
                                                                                <option value="否">否</option>
                                                                            </select>
                                                                        </td>
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;">
                                                                            <div class="container">
                                                                                <form method="post" action="" enctype="multipart/form-data" id="myform">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="file" id="customFile3" name="customFile3" />
                                                                                        <!-- <input type="button" class="button" value="Upload" id="but_upload"> -->
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                            <select id="file3_check" style="width:200px;">
                                                                                <option value="是">是</option>
                                                                                <option value="否">否</option>
                                                                            </select>
                                                                        </td>
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;">
                                                                            <div class="container">
                                                                                <form method="post" action="" enctype="multipart/form-data" id="myform">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="file" id="customFile4" name="customFile4" />
                                                                                        <!-- <input type="button" class="button" value="Upload" id="but_upload"> -->
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                            <select id="file4_check" style="width:200px;">
                                                                                <option value="是">是</option>
                                                                                <option value="否">否</option>
                                                                            </select>
                                                                        </td>
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <textarea style="height:10em;width:700px;resize: none;font-size: 20px;" id="upload_res_remark" name="upload_res_remark" placeholder="請輸入備註"></textarea>
                                                                        </td>
                                                                    </tr>
