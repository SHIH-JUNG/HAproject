                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <table id="ma_yearlist_all" style="width:auto;" class="table table-bordered">
                                                                    <th>年度</th>
                                                                    <th>會議資料</th>
                                                                    <tbody id="ma_yearlist_add"></tbody>
                                                                </table>
                                                                <button style="font-size:20px" onclick="location.href='add_members_assemble_v2.php';" class="btn btn-default">
...
-->
    ...
    <!-- ================== members_assemble_yearlist_v2.js ================== -->
    <script src='js/members_assemble_yearlist_v2.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
