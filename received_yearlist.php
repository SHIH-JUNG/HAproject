                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="re_yearlist_all" style="width:auto;" class="table table-bordered">
                                                                    <th>年度</th>
                                                                    <th>收文資料</th>
                                                                    <tbody id="re_yearlist_add"></tbody>
                                                                </table>
                                                                <button style="font-size:20px" onclick="location.href='add_received.php';" class="btn btn-default">新增收文資料</button>
