...
$.ajax({
  ...
  success: function (data) {
    ...
    $.each(data, function (index, value) {
      ...
      {
          var supervise_sign_file_val = value.Supervise_signature.replace("\.\.\/members_assemble\/signature\/", "\.\/members_assemble\/signature\/");
      ...
      cssString += '<td style="text-align:center">' + value.Supervise+sign_css_str + '</td>';
      cssString += '</tr>';
    });
