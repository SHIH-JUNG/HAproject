                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {
                                echo '<li><span>'.trim($rec_year).'年度會員大會記錄</span></li>';
                            }
                            else
                            {
                                echo '<li><span>全部年度會員大會記錄</span></li>';
                            }
                                            ...
                                            <div class="table-wrap">
                                                ...
                                                <h4 class="all_year_datas">查詢</h4>
                                                    ...
                                                    <?php 
                                                        if(trim($rec_year) != 'all')
                                                        {
                                                            echo '<h4>'.trim($rec_year).'年度會員大會記錄</h4>';
                                                        }
                                                        else
                                                        {
                                                            echo '<h4>全部年度會員大會記錄</h4>';
                                                        }
                                                    ?>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th class="text-right" colspan="16">
                                                                    <a href="add_members_assemble_v2.php"><button style="font-size:15px" type="button" class="btn btn-default"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
-->
    ...
    <!-- ================== members_assemble ================== -->
    <script type="text/javascript" src="js/members_assemble_v2.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
    <!-- ================== 地區選擇下拉 ================== -->
    <!--
