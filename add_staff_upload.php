                        ...
                        <div class="table-wrap">
                          <div class="table-responsive">
                            <table style="width:auto;" class="table table-bordered">
                              ...
                              <tr style="text-align:left">
                                <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;"><i style="color:red;">※</i>合約書</td>
                                <td style="border-bottom: solid 1px;">
                                  <form method="post" enctype="multipart/form-data" action="staff_upload.php">
                              ...
                              <tr style="text-align:left">
                                <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;"><i style="color:red;">※</i>畢業證書</td>
                                <td style="border-bottom: solid 1px;">
                                  <form method="post" enctype="multipart/form-data" action="staff_upload.php">
                                    <input type="file" name="my_file">
                                    <br>
                              ...
                              <tr style="text-align:left">
                                <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;"><i style="color:red;">※</i>證照證書</td>
                                <td style="border-bottom: solid 1px;">
                                  <form method="post" enctype="multipart/form-data" action="staff_upload.php">
                                    <input type="file" name="my_file">
                                    <br>
                              ...
                              <tr style="text-align:left">
                                <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;"><i style="color:red;">※</i>考核績效</td>
                                <td style="border-bottom: solid 1px;">
                                  <form method="post" enctype="multipart/form-data" action="staff_upload.php">
                                    <input type="file" name="my_file">
                                    <br>
                              ...
                              <button id="staff_add_new" style="font-size:15px" type="button" class="btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
