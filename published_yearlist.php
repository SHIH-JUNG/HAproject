                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="pu_yearlist_all" style="width:auto;" class="table table-bordered">
                                                                    <th>年度</th>
                                                                    <th>發文資料</th>
                                                                    <tbody id="pu_yearlist_add"></tbody>
                                                                </table>
                                                                <button style="font-size:20px" onclick="location.href='add_published.php';" class="btn btn-default">新增發文資料</button>
...
-->
    ...
    <script src='js/published_yearlist.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
