                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="tra_off_all" style="width:auto;" class="table table-bordered">
                                                                    <th>姓名</th>
                                                                    <th>訓練紀錄</th>
                                                                    <tbody id="tra_off_all"></tbody>
                                                                </table>
                                                                <!-- <br> -->
                                                                <!-- <button style="font-size:20px" onclick="location.href='add_training.php';" class="btn btn-default">新增員工訓練資料</button> -->
...
-->
    ...
    <script src='js/training_off.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
