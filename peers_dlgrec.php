                                                ...
                                                <div class="col-sm-12">
                                                    <table style="font-size:20px;font-family:微軟正黑體;width:100%" class="table table-bordered NOline">
                                                        <tr>
                                                            ...
                                                            <td class="text-left" style="width: 28em;">
                                                                <input id="min_date" name="fillin_date" class="" type="date" placeholder="日期搜尋">
                                                                <label>～</label>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th class="text-right" colspan="15">
                                                                           <a href="add_peers_dlgrec.php"><button style="font-size:15px" type="button" class="btn btn-default"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
-->
    ...
    <!-- ================== peers_dlgrec ================== -->
    <script type="text/javascript" src="js/peers_dlgrec.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
    <!-- ================== 地區選擇下拉 ================== -->
    <!--
