                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <table id="sr_yearlist_all" style="width:auto;" class="table table-bordered">
                                                                    <th>年度</th>
                                                                    <th>會議資料</th>
                                                                    <tbody id="sr_yearlist_add"></tbody>
                                                                </table>
                                                                <button style="font-size:20px" onclick="location.href='add_supervisor_record_v2.php';" class="btn btn-default">
...
-->
    ...
    <!-- ================== supervisor_record_yearlist_v2.js ================== -->
    <script src='js/supervisor_record_yearlist_v2.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
