<form id="form_b" class="form" action="">
    <table id="all_data" style="width:75%;margin-bottom: 0px;" class="table table-bordered">
        ...
        <tr style="text-align:left">
            ...
            <td style="border-bottom: solid 1px;"><input class="ma_question" id="upload_rec_date" name="upload_rec_date" datepicker="ch_datepicker" type="text"></td>
        </tr>
        <tr style="text-align:left">
        ...
        <tr style="text-align:left">
            ...
            <td>
                <textarea style="height:10em;width:700px;resize: none;font-size: 20px;" class="ma_question" id="upload_rec_remark" name="upload_rec_remark" placeholder="請輸入備註"></textarea>
            </td>
        </tr>
        <tr style="text-align:left">
