    ...
    <table id="all_data" style="width:75%;margin-bottom: 0px;" class="table table-bordered">
        ...
        <tr style="text-align:left">
            ...
            <td style="border-bottom: solid 1px;">
                <div class="col-sm-12">
                    <div class="text-left">
                        <input class="ma_question" name="customFile1" type="file" class="form-control" />
                        <br>
        ...
        <tr style="text-align:left">
            ...
            <td>
                <div class="col-sm-10"><textarea style="height:10em;width:100%;resize: none;font-size: 20px;" class="ma_question" id="upload_rec_remark" name="upload_rec_remark" placeholder="請輸入備註"></textarea></div>
            </td>
        </tr>
        <tr style="text-align:left">
