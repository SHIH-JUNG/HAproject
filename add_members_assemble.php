                                                            ...
                                                            <form id="form_a" class="form">
                                                                <table style="width:70%;" class="table table-bordered">
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:7em;width:100%;resize: none;font-size: 20px;" id="attendees" name="attendees" placeholder="請輸入出席人員"></textarea>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:7em;width:100%;resize: none;font-size: 20px;" id="absent" name="absent" placeholder="請輸入請假人員"></textarea>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td style="border-bottom: solid 1px;">
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:10em;width:100%;resize: none;font-size: 20px;" id="record" name="record" placeholder="請輸入會議記錄者"></textarea>
                                                                                <!-- <input id="record" name="record" type="text" style="width:37em;"> -->
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:10em;width:100%;resize: none;font-size: 20px;" id="discuss" name="discuss" placeholder="請輸入提案討論內容"></textarea>  
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:16em;width:100%;resize: none;font-size: 20px;" id="motion" name="motion" placeholder="請輸入臨時動議內容"></textarea>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                            ...
                                                            <form id="form_b" class="form" action="">
                                                                <table style="width:70%;" class="table table-bordered">
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10">
                                                                                <textarea style="height:10em;width:100%;resize: none;font-size: 20px;" id="upload_rec_remark" name="upload_rec_remark" placeholder="請輸入備註"></textarea>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
