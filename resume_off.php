                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <br>
                                                                <table id="res_off_all" style="width:auto;" class="table table-bordered">
                                                                    <th>姓名</th>
                                                                    <th>履歷表檔案</th>
                                                                    <tbody id="res_off_add"></tbody>
                                                                </table>
                                                                <!-- <button style="font-size:20px" onclick="location.href='add_resume_on.php';" class="btn btn-default">新增履歷表檔案</button> -->
...
-->
    ...
    <script src='js/resume_off.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
