...
#peers_dlgrec_tab tbody tr td textarea
{
    width:85%;
    /* border: none; */
    min-height:6em;
...
<body>
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <div class="table-wrap">
                                                    <div class="table-responsive">
                                                        <table style="width:75%;" class="table table-bordered" id="peers_dlgrec_tab">
                                                            <tr>
                                                                <td colspan="2">
                                                                    <h3>新增每日生活輔導紀錄表</h3>
                                                                </td>
                                                            ...
                                                            <tr style="text-align:left">
                                                                ...
                                                                <td style="border-bottom: solid 1px;">
                                                                <textarea id="peers_dlgrec_8" name="peers_dlgrec_textarea" placeholder="請輸入特殊個案反應情形輔導處理" contenteditable="true"></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr style="text-align:left">
                                                                ...
                                                                <td style="border-bottom: solid 1px;">
                                                                <textarea id="peers_dlgrec_9" name="peers_dlgrec_textarea" placeholder="請輸入輔導諮詢執行實況" contenteditable="true"></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr style="text-align:left">
                                                                <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">問題處遇概況</td>
                                                                <td style="border-bottom: solid 1px;">
                                                                <textarea id="peers_dlgrec_10" name="peers_dlgrec_textarea" placeholder="請輸入問題處遇概況" contenteditable="true"></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr style="text-align:left">
                                                                <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">備註</td>
                                                                <td style="border-bottom: solid 1px;">
                                                                <textarea id="peers_dlgrec_11" name="peers_dlgrec_textarea" placeholder="請輸入備註" contenteditable="true"></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr style="text-align:left">
                                                                <td colspan="2" style="border-bottom: solid 1px;">
                                                ...
                                                <br>
                                                <button id="peers_dlgrec_add_new" style="font-size:15px" type="button" class="btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
                                                        <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z" />
                                                        <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
                                                    </svg>新增</button>
                                                <a href="peers_dlgrec.php"><button style="font-size:15px" type="button" class="btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-excel" viewBox="0 0 16 16">
    ...
    <!-- ================== add_peers_dlgrec.js ================== -->
    <script src="js/add_peers_dlgrec.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
</body>
