<form id="form_a" class="form" action="">
    <table id="all_data" style="width:75%;margin-bottom: 0px;" class="table table-bordered">
        ...
        <tr style="text-align:left">
            ...
            <td>
                <textarea style="height:7em;width:37em;resize: none;font-size: 20px;" class="bs_question" id="absent" name="absent" placeholder="請輸入請假人員"></textarea>
            </td>
        </tr>
        <tr style="text-align:left">
        ...
        <tr style="text-align:left">
            ...
            <td>
                <textarea style="height:10em;width:700px;resize: none;font-size: 20px;" class="bs_question" id="discuss" name="discuss" placeholder="請輸入提案討論內容"></textarea>
            </td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-right-color: white">臨時動議</td>
            <td>
                <textarea style="height:16em;width:700px;resize: none;font-size: 20px;" class="bs_question" id="motion" name="motion" placeholder="請輸入臨時動議內容"></textarea>
            </td>
        </tr>
        <tr style="text-align:left">
