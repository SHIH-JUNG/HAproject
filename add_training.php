...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <br>
                                                <button id="tra_add_new" style="font-size:15px" type="button" class="btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
    ...
    <!-- ================== add_phone.js ================== -->
    <script src="js/add_training.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
</body>
