...
//                            '<td><input id="date_self'+value.number+'" type="date" value="'+value.date_self+'"></td>'+
                    ...
                    '<td><a href="placement_case_all.php?name='+value.Name+'&pid='+value.Case_pid+'&date='+value.Open_case_date+'&property='+ value.Case_property +'&type='+ value.Object_type+'&id='+value.Id+'&open_id='+value.Case_id+'&referral='+value.Referral+'&case_Create_date='+value.Case_Create_date+'&unopen_type='+value.Unopen_type+'&birth='+value.Birth+'">點擊進入</a></td>'+
