    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data,function(index,value){
                ...
                var dlgrec_file_path = value.Upload_path.replace("../", "./");
                dlgrec_file_name = value.Upload_name;

                var a_element_content = '<a href="'+dlgrec_file_path+'" style="text-decoration:none;color:blue;" target="_blank">'
                +dlgrec_file_name
                +'</a><br/><br/>';
...
function check_file_exist() {
    ...
    $.each(file_arr, function (index, value) {
      $.ajax({
        url: "database/dlgrec_file_check.php",
        data: {
          file_name: value,
        },
        type: "POST",
...
$("#dlgrec_update").on("click", function () {
  ...
  function submit_form() {
    ...
    $("input, textarea").each(function () {
      ...
      form_data.append("dlgrec_date", $("#dlgrec_date").val());

      form_data.append("dlgrec_0",$("#dlgrec_0").val());
      form_data.append("dlgrec_1",$("#dlgrec_1").val());
      form_data.append("dlgrec_2",$("#dlgrec_2").val());
      form_data.append("dlgrec_3",$("#dlgrec_3").val());
      form_data.append("dlgrec_4",$("#dlgrec_4").val());
      form_data.append("dlgrec_5",$("#dlgrec_5").val());
      form_data.append("dlgrec_6",$("#dlgrec_6").val());
      form_data.append("dlgrec_7",$("#dlgrec_7").val());
      form_data.append("dlgrec_8",$("#dlgrec_8").val());
      form_data.append("dlgrec_9",$("#dlgrec_9").val());
      form_data.append("dlgrec_10",$("#dlgrec_10").val());
      form_data.append("dlgrec_11",$("#dlgrec_11").val());
