...
var received_date_range = (function( settings, data, dataIndex ) {
  var min_date = parseInt(Date.parse( trans_to_EN($('#received_min_date').val())), 10 );
  var max_date = parseInt(Date.parse( trans_to_EN($('#received_max_date').val())), 10 );
...
$("#received_min_date, #received_max_date").on("change", function () {
  //    console.log($('#min_date').val())
  $.fn.dataTable.ext.search.push(received_date_range);
  $table.draw();
});
