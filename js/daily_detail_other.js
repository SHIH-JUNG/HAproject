...
function add_new(){
    ...
    $.ajax({
        url: "database/add_daily_detail_o.php",
        data: {
...
$("#preview").on('click', function(){
    ...
    var name = getUrlVars()["name"];
    var addition = getUrlVars()["addition"];
    window.location.href ='detail_other_preview.php?face_id='+face_id+'&number='+number+'&name='+name+'&addition='+addition+'&date='+$("#date").text()+'';
})
//endregion
