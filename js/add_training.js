...
window.selectedFiles1 = []; //新載入資料
window.selectedFiles1_str = []; //新載入資料名稱
...
function check_file_exist() {
    var check_file_value = selectedFiles1_str;
    var warning_str = "";
    var file_arr = [];
    var file_n = "";
    var exist_info = [];
    ...
    for (var i = 0; i < check_file_value.length; i++) {
        file_arr.push(check_file_value[i]);
    }
...
$("#tra_add_new").on("click", function() {
    ...
    if (selectedFiles1_str.length != 0) {
