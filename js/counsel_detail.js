...
$("#trans_to_opencase_submit").on('click',function(){
    ...
    {
        window.location.href = 'phone_trans_to_opencase.php?counsel_id='+counsel_id.replace(/^\s+|\s+$/gm,'')+'&case_id='+$('#open_case_t_sn').val().replace(/^\s+|\s+$/gm,'')+'&case_property='+$('#open_case_type').val()+'';
    }
});
//endregion
