...
function store(num){
    ...
    var inside_id = getUrlVars()["id"];
    var house = decodeURIComponent(getUrlVars()["house"]);
    var enter_date = getUrlVars()["enter_date"];
    var four_id = getUrlVars()["four_id"];
    var face_num = getUrlVars()["face_num"];
    $.ajax({
        url: "database/add_inside_all.php",
        data: {
            face_id:face_id,
            open_id:open_id,
            url: 'inside_note.php?face_id='+face_id+'&open_id='+open_id+'&number='+num+'&name='+name+'&addition='+addition+'&enter_date='+enter_date+'&inside_id='+inside_id+'&house='+house+'&four_id='+four_id+'&face_num='+face_num+'',
            name: name,
            addition: addition,
            house: house,
