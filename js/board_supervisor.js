...
//團督記錄表格region
$.ajax({
  url: "database/find_data_board_supervisor.php",
  type: "POST",
  dataType: "JSON",
  data: {
    year: bs_year,
  ...
  success: function (data) {
    ...
    $.each(data, function (index, value) {
      ...
      {
          var supervise_sign_file_val = value.Supervise_signature.replace("\.\.\/board_supervisor\/signature\/", "\.\/board_supervisor\/signature\/");
      ...
      cssString += '<td style="text-align:center">' + value.Supervise+sign_css_str + '</td></tr>';
    });
