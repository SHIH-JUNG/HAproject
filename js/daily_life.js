//抓所有詢戒日常生活總表region
$.ajax({
    url: "database/find_dailylife.php",
    type: "POST",
    dataType: "JSON",
    async: false,//啟用同步請求
...
//            console.log(data.id[index])
            cssString += 
                    '<tr>' +
                        ...
                        '<td><a href="daily_all.php?face_id='+data.face_id[index]+'&name='+data.name[index]+'&date='+data.face_date[index]+'&addition='+data.addition[index]+'"><button>進入</button></a></td>' +
...
//                console.log($(this).attr("rel"));
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type: 'POST',
                            url: 'database/delete_daily_life.php',
                            async: false,
                            data: {
                                id: id,
                                face_id:face_id
...
//table設定region
var $table = $('#tab_daily_life').DataTable({
    "ordering": false,
    "info": true,
    "paging": true,
