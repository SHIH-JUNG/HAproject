  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (index, value) {
        ...
        if (inputs_type_files.length > 0) {
          ...
          for (var i = 0; i < inputs_type_files.length; i++) {
            ...
            var file_html =
              '<a name="customFile' +
              (i + 1) +
              '_a" href="./supervisor_record/upload/' +
              file_val +
              '" style="text-decoration:none;color:blue;" target="_blank">' +
              file_val +
              '<br/><img style="vertical-align:middle;" width="auto" src="./supervisor_record/upload/' +
              file_val +
              '"></a>';
        ...
        {
          $("#supervise_signature_simg").attr("href", "./supervisor_record/signature/"+supervise_sign_file_val)
        }
