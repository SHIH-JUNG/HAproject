...
$.ajax({
    ...
    success: function (data) {
        ...
        $.each(data,function(index,value){
            ...
            if(value.file_path=="")
            {
                cssString +='<tr id="'+value.Id+'" sr_id="'+value.Id+'" rec_type="fillin">';
            ...
            {   
                cssString +='<tr id="'+value.Id+'" sr_id="'+value.Id+'" rec_type="upload">';

                var upload_content_json = JSON.parse("[" +value.upload_content.replace('\"\[', '\[').replace('\]\"', '\]') + "]");
