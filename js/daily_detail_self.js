...
$(document).ready(function(){
    ...
    $.ajax({
        url: "database/find_daily_self.php",
        data: {
            face_id: id,
            number: number,
        },
...
//    var sleep = $("input[name='sleep[]']:checked").val();
    ...
    $.ajax({
        url: "database/add_daily_detail_s.php",
        data: {
...
$("#preview").on('click', function(){
    ...
    var name = getUrlVars()["name"];
    var addition = getUrlVars()["addition"];
    window.location.href ='detail_self_preview.php?face_id='+face_id+'&number='+number+'&name='+name+'&addition='+addition+'&date='+$("#date").text()+'';
})
//endregion