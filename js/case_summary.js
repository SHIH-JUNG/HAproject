...
//抓所有個案region
$.ajax({
    url: "database/find_case_summary.php",
    type: "POST",
    dataType: "JSON",
    async: false,//啟用同步請求
    success: function (data) {
        ...
        $.each(data,function(index,value){
            var isClose = '';
            if(value.Case_state == "已結案"){
                isClose = '<td style="text-align:center">' + value.Close_case_date + '</td>'+
                        '<td style="text-align:center">' + value.Case_assign + '</td>';
            }
            else{
                isClose = '<td style="text-align:center"></td>'+
