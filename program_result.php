            ...
            <div class="container-fluid ">
                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="program_result.php">方案計畫</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                    </ol>
                                                ...
                                                <div class="col-sm-12">
                                                    <table style="font-size:20px;font-family:微軟正黑體;width:100%" class="table table-bordered NOline">
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <select id="plan_name" rel="2" class="filter search">
                                                                    <!-- <option value="">所有</option> -->
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-right" style="background-color:rgb(255 201 54)">其他附件是否上傳：</td>
                                                            <td class="text-left">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th class="text-right" colspan="15">
                                                                    <a href="add_program_result.php"><button style="font-size:15px" type="button" class="btn btn-default"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
-->
    ...
    <!-- ================== phone ================== -->
    <script type="text/javascript" src="js/program_result.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
    <!-- ================== 地區選擇下拉 ================== -->
    <!--
