            ...
            <div class="container-fluid ">
                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="board_supervisor_yearlist.php">理監事會紀錄</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><?php echo trim($rec_year); ?>年度理監事會紀錄</span></li>
                    </ol>
                    <!--/麵包屑-->
                </div>
                <!-- /Title -->
                                ...
                                <div class="panel-body">
                                    <div class="table-wrap">
                                        <div class="table-responsive">
                                            <h4><?php echo trim($rec_year); ?>年度理監事會紀錄</h4>
                                            <div class="table-wrap">
                                                <div class="table-responsive">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th class="text-right" colspan="16">
                                                                    <a href="add_board_supervisor.php"><button style="font-size:15px" type="button" class="btn btn-default"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
-->
    ...
    <!-- ================== board_supervisor ================== -->
    <script type="text/javascript" src="js/board_supervisor.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
    <!-- ================== 地區選擇下拉 ================== -->
    <!--
