                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <button style="font-size:20px" onclick="window.location.href = 'current_case.php';" class="btn btn-default">
...
-->
    ...
    <!-- ================== case_all.js ================== -->
    <script src='js/case_all_all.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
