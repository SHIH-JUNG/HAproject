<form id="form_a" class="form" action="">
    <table id="all_data" style="width:75%;margin-bottom: 0px;" class="table table-bordered">
        <tr style="text-align:left">
            ...
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="sr_question" id="title_name" name="title_name" type="text" style="width:100%;"></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">會議日期</td>
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="sr_question" id="meeting_date" name="meeting_date" datepicker="ch_datepicker" type="text"></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">會議時間</td>
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="sr_question" id="meeting_time" name="meeting_time" type="time"></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">會議地點</td>
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="sr_question" id="place" name="place" type="text" style="width:100%;"></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">主席</td>
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><input class="sr_question" id="ceo_name" name="ceo_name" type="text" style="width:100%;"></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">出席人員</td>
            <td>
                <div class="col-sm-10"><textarea style="height:7em;width:100%;resize: none;font-size: 20px;" class="sr_question" id="attendees" name="attendees" placeholder="請輸入出席人員"></textarea></div>
            </td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">請假人員</td>
            <td>
                <div class="col-sm-10"><textarea style="height:7em;width:100%;resize: none;font-size: 20px;" class="sr_question" id="absent" name="absent" placeholder="請輸入請假人員"></textarea></div>
            </td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">紀錄者</td>
            <td style="border-bottom: solid 1px;"><div class="col-sm-10"><textarea style="height:10em;width:100%;resize: none;font-size: 20px;" class="sr_question" id="record" name="record" placeholder="請輸入會議記錄者"></textarea></div></td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-right-color: white">督導建議</td>
            <td>
                <div class="col-sm-10"><textarea style="height:10em;width:100%;resize: none;font-size: 20px;" class="sr_question" id="suggest" name="suggest" placeholder="請輸入督導建議"></textarea></div>
            </td>
        </tr>
        <tr style="text-align:left">
            <td style="text-align:right;background-color:rgb(255 201 54);border-right-color: white">下次團督重點</td>
            <td>
                <div class="col-sm-10"><textarea style="height:16em;width:100%;resize: none;font-size: 20px;" class="sr_question" id="next_focus" name="next_focus" placeholder="請輸入下次團督重點"></textarea></div>
            </td>
        </tr>
        <tr style="text-align:left">
