...
<body>
                                                                            ...
                                                                            <table id="all_data" style="width:75%;margin-bottom: 0px;" class="table table-bordered">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        <select id="on_or_off" class="res_question" style="width:200px;">
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        ...
                                                                                        <select id="file1_check" class="res_question" style="width:200px;">
                                                                                            <option value="是">是</option>
                                                                                            <option value="否">否</option>
                                                                                        </select>
                                                                                    </td>
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        ...
                                                                                        <select id="file2_check" class="res_question" style="width:200px;">
                                                                                            <option value="是">是</option>
                                                                                            <option value="否">否</option>
                                                                                        </select>
                                                                                    </td>
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        ...
                                                                                        <select id="file3_check" class="res_question" style="width:200px;">
                                                                                            <option value="是">是</option>
                                                                                            <option value="否">否</option>
                                                                                        </select>
                                                                                    </td>
                                                                                ...
                                                                                <tr style="text-align:left">
                                                                                    ...
                                                                                    <td style="border-bottom: solid 1px;">
                                                                                        ...
                                                                                        <select id="file4_check" class="res_question" style="width:200px;">
                                                                                            <option value="是">是</option>
                                                                                            <option value="否">否</option>
                                                                                        </select>
                                                                                    </td>
    ...
    <!-- ================== detail ================== -->
    <script type="text/javascript" src="js/resume_detail.js<?php echo "?".date("Y-m-d h:i:sa")?>"></script>
