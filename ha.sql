...
(58, '8_6_RE111', '開案個案-(生活品質問卷)簽核：案號：RE111', 'case_all.php?name=test&gender=男&pid=T1334356112&date=2022-08-08&property=安置家園&type=藥癮家庭&grade=B&id=6&open_id=RE111&referral=其他&case_Create_date=2022-08-08&unopen_type=reopencase&birth=1991-02-03&form_type=life', '2023-07-14 00:00', '社工員1', '園主任、執行長', '園主任未簽核、執行長未簽核', 'current_case', '2023-07-14 12:17:27', '執行長', '2023-07-14 12:17:27', '');
...
(2, '112年第15次志工會議', '112年06月01日', '08:00', '11:00', 'test會議地點11215', 'testuser1\r\ntestuser2\r\ntestuser3\r\ntestuser4\r\ntestuser5', '', '12', '1', 'test\r\n會議議程\r\n11215', '\"[{\"input_id\":\"proposal_contents_1\",\"val\":\"決議：test決議1\"},{\"input_id\":\"proposal_contents_2\",\"val\":\"決議：test決議2\"},{\"input_id\":\"proposal_contents_3\",\"val\":\"決議：test3\"},{\"input_id\":\"proposal_contents_4\",\"val\":\"決議：\"}]\"', 'test\r\n檢討及建議\r\n11215', 'test\r\n臨時動議\r\n11215', '112年06月30日', '../volunteer_meeting/志工簽到表test11215.png', '../volunteer_meeting/志工閱後簽退test11215.png', '[\"../volunteer_meeting/p4.jpg\",\"../volunteer_meeting/p3.jpg\",\"../volunteer_meeting/p2.jpg\",\"../volunteer_meeting/p1.jpg\",\"../volunteer_meeting/p6.jpg\",\"../volunteer_meeting/p5.jpg\"]', '2023-06-26 19:55:08', '執行長', '2023-07-14 12:09:53', '執行長');
...
--
ALTER TABLE `form_case_report`
  MODIFY `Id` int(244) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `login_record`
  MODIFY `Id` int(240) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;
