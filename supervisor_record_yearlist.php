                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                ...
                                                                <button style="font-size:20px" onclick="location.href='add_supervisor_record.php';" class="btn btn-default">新增團督記錄</button>
...
-->
    ...
    <!-- ================== supervisor_record_yearlist.js ================== -->
    <script src='js/supervisor_record_yearlist.js<?php echo "?".date("Y-m-d h:i:sa")?>'></script>
    <!-- ================== moment ================== -->
