...
$select_id_num = "SELECT MAX(Id) FROM `board_supervisor_v2` ORDER BY `board_supervisor_v2`.`Create_date` ASC LIMIT 1;";
...
$sql = "INSERT INTO `board_supervisor_v2` (`Id`, `Year`, `upload_content`, `Agenda_file_path`, `Rec_file_path`, `Create_date`, `Create_name`, `Director`, `Supervise`) VALUES 
($bs_id, '$year', '$upload_content', '$file_0_arr','$file_1_arr', NOW(), '$user', '$Director', '$Supervise');";
...
VALUES ('$bs_id', '$title','$url','$rec_date_time', '$user', '$signer', '$sign_state', 'board_supervisor', Now(), '$user');";
