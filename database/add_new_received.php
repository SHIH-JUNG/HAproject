...
`Num_receive`, `Upload_path`, `Upload_name`,`Supervise`, `Leader`, `Director`, `Create_date`,`Create_name`) VALUES
 ($received_id, '$Year','$Title_Name','$Received_date','$Subject','$Unit','$Num_receive', '$file', '$file_name', '$Supervise', '$Leader', '$Director', Now(),'$user');";
