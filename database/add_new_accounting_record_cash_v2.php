...
// $Invoice_year = (int)$_POST['year'];
// $Invoice_month = (int)$_POST['month'];

$Form_class = $_POST['Form_class'];
$Invoice_year = (int)$_POST['Invoice_year'];
$Invoice_month = (int)$_POST['Invoice_month'];
...
else
{
    ...
    if($Form_class=="兒少單據")
    {
        $sql = "INSERT INTO `accounting_record_cash_v2` (`Id`, `Year`, `Month`,`Form_class`, `Invoice_type`, `Amount`, `Remark`, `Create_date`, `Create_name`) VALUES
        ($arc_id, $Invoice_year, $Invoice_month, '$Form_class',
        '$Invoice_type', '$Amount', '$Remark', NOW(), '$user');";
    }
