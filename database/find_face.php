...
for($i=1; $i <= mysqli_num_rows($select_note);$i++){
    ...
    array_push($data['Location'], $note_text[29]);   
    array_push($data['Location_detail'], $note_text[30]);
    array_push($data['Start_date'], $note_text[31]);
    array_push($data['End_date'], $note_text[32]);    
    array_push($data['Start_time'], $note_text[33]);    
    array_push($data['End_time'], $note_text[34]);    
    array_push($data['One_user_name'], $note_text[35]);    
    array_push($data['Two_user_name'], $note_text[36]);    
    array_push($data['Remark'], $note_text[37]);
