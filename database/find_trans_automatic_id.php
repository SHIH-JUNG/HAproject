...
elseif($keyword == "親職兒少")
{
    $sqlstr = "SELECT REPLACE(`Case_id`, '$ab_id_str', '') AS `Case_id` FROM `current_case` WHERE `Object_type`='親職兒少' AND `Case_id` like '$ab_id_str%' ORDER BY REPLACE(`Case_id`, '$ab_id_str', '') DESC LIMIT 1";
}
else
{
