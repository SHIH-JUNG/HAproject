            ...
            <div class="container-fluid ">
                ...
                <div class="row heading-bg  bg-green">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="peers_dlgrec.php">個案管理</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><a href="peers_dlgrec.php">安置中心生輔紀錄</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><a href="peers_dlgrec.php">同儕生輔紀錄</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                        <li><span><a href="dlgrec.php">同儕生輔紀錄一覽表</a></span></li>
                        <svg width="0.8em" height="0.8em" viewBox="0 0 16 16" class="bi bi-chevron-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-sm-12">
                                                <ul style="font-size:17px" class="nav nav-tabs" id="myTab" role="tablist">
                                                    <li class="nav-item active" role="presentation" id="peers_dlgrec_rec_all">
                                                                    ...
                                                                    <div class="panel-body scr_container">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td colspan="2" style="border-bottom: solid 1px;">
                                                                                <label for="bf_num">早餐：</label><input style="width:3.5em;" class="peers_dlgrec_question" id="bf_num" type="number">人、
                                                                                <label for="al_num">午餐：</label><input style="width:3.5em;" class="peers_dlgrec_question" id="al_num" type="number">人、
                                                                                <label for="em_num">晚餐：</label><input style="width:3.5em;" class="peers_dlgrec_question" id="em_num" type="number">人，
                                                                                <label for="lp_num">當日入住人數：</label><input style="width:3.5em;" class="peers_dlgrec_question" id="lp_num" type="number">人、
                                                                                <label for="leave_num">請假：</label><input style="width:3.5em;" class="peers_dlgrec_question" id="leave_num" type="number">人<br/><br/>
                                                                                <label for="peers_dlgrec_date">日期：</label><input style="width:9em;" class="peers_dlgrec_question" id="peers_dlgrec_date" type="date">
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="text-align:left">
                                                                            <td colspan="2" style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">6:50<br/>9:00</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">9:00<br/>11:10</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">11:10<br/>12:00</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">12:00<br/>14:00</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">14:00<br/>16:10</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">16:10<br/>21:30</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                        ...
                                                                        <tr style="text-align:left">
                                                                            ...
                                                                            <td style="border-bottom: solid 1px;">
                                                                            <textarea class="peers_dlgrec_question" id="peers_dlgrec_8" name="peers_dlgrec_textarea" placeholder="請輸入特殊個案反應情形輔導處理" contenteditable="true"></textarea>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="text-align:left">
                                                                            ...
                                                                            <td style="border-bottom: solid 1px;">
                                                                            <textarea class="peers_dlgrec_question" id="peers_dlgrec_9" name="peers_dlgrec_textarea" placeholder="請輸入輔導諮詢執行實況" contenteditable="true"></textarea>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">問題處遇概況</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                            <textarea class="peers_dlgrec_question" id="peers_dlgrec_10" name="peers_dlgrec_textarea" placeholder="請輸入問題處遇概況" contenteditable="true"></textarea>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="text-align:left">
                                                                            <td style="text-align:center;background-color:rgb(255 201 54);border-bottom-color: white;border-right-color: white;">備註</td>
                                                                            <td style="border-bottom: solid 1px;">
                                                                            <textarea class="peers_dlgrec_question" id="peers_dlgrec_11" name="peers_dlgrec_textarea" placeholder="請輸入備註" contenteditable="true"></textarea>
                                                                            </td>
                                                                        </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    <div id="edit_div">
                                                                                        <button style="font-size:20px" id="peers_dlgrec_edit" class="btn btn-default" onclick="peers_dlgrec_edit();">編輯</button>
                                                                                    </div>
                                                                                    <div id="save_div" hidden>
                                                                                        <button style="font-size:20px" id="peers_dlgrec_update" class="btn btn-default">修改</button>
                                                                                        <button style="font-size:20px" id="peers_dlgrec_cancel" class="btn btn-default" onclick="peers_dlgrec_cancel();">取消</button>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
