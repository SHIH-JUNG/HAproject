                                                            ...
                                                            <form id="form_a" class="form">
                                                                <table style="width:70%;" class="table table-bordered">
                                                                    ...
                                                                    <tr style="text-align:left">
                                                                        ...
                                                                        <td>
                                                                            <div class="col-sm-10"><textarea style="height:10em;width:100%;resize: none;font-size: 20px;" id="suggest" name="suggest" placeholder="請輸入督導建議"></textarea></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
                                                                        <td style="text-align:right;background-color:rgb(255 201 54);border-right-color: white">下次團督重點</td>
                                                                        <td>
                                                                            <div class="col-sm-10"><textarea style="height:16em;width:100%;resize: none;font-size: 20px;" id="next_focus" name="next_focus" placeholder="請輸入下次團督重點"></textarea></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="text-align:left">
